...
import com.ffzx.purchase.api.dto.PurchaseOrder;

@SuppressWarnings({ "unchecked", "rawtypes","unused" })
public class InitFilesByModel {
	
	public static void main(String[] args) throws IOException {
		String workSpacePath = "F:\\Workspace\\cims";
		String project = "cims-core";
		Class c = com.ffzx.commodity.api.dto.Commodity.class;//NewPerson.class;
